...
const Spinner = () => {
    return (
        ...
        <div role="status">
            ...
            dark:text-gray-600 fill-indigo-600"
                ...
                <path
                    ...
                    28.8227 92.871 24.3692 89.8167 20.348C85.8452 15.1192 80.8826 10.7238 75.2124
                     ...
                     6.62326C39.0873 9.04874 41.5694 10.4717 44.0505 10.1071C47.8511 9.54855
                     51.7191 9.52689 55.5402 10.0491C60.8642 10.7766 65.9928 12.5457 70.6331
